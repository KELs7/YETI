...
class MyTestCase(unittest.TestCase):
    ...
    def test_03_distributing_reward_token_other_than_tau_works(self):
        ...
        self.assertAlmostEqual(self.currency.balances['con_distr_rewards_yeti'], tau_left_for_distr_fee)
    ...
    def test_05_holder_with_less_than_minimum_does_not_receive_rewards(self):
        ...
        self.assertAlmostEqual(self.currency.balances['con_distr_rewards_yeti'], tau_left_for_distr_fee+undistr_amount)
